...
public:
	...
	const sf::Vector2f& getPosition() const;	//BEFORE DEBUG>>WALL HALF WORKING
	//const sf::Vector2f getPosition() const; //Doesn't start from top left, but doesn't actually change
